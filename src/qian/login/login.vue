<template>
      ...
      <div>
         <p class="p-title">LCG我爱编码,蛟龙在线,欢迎点评1111111</p>
      </div>
        <div class="ms-login">
          <div class="ms-title">
             欢迎使用
  ...
  import axios from 'axios'
    export default {
        ...
        submitForm(ruleid){
           ...
           if(code==null||code==""){
            ...
            //打开登陆进度条
             ...
             axios.post(this.domain.serverpath+"login",qs.stringify(params)).then((response)=>{
                ...
                if(respo.success=="ok"){
                  ...
                  this.$router.push({path:'/view/zhu/zhu',query:{username:respo.result.username,userid:respo.result.id}});
      ...
      mounted(){
        ...
        //从后台获取滑动验证码
        //参数 url 访问参数
        axios.post(this.domain.serverpath+'getCode').then((response)=>{
